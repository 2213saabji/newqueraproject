...
export default function Home({ title, settitle, content, setcontent, imgpost, setimgpost, setuppercase, handleFileSelection, imagepicker, imagestorediv, inputpicuploader, uppercase, delpostaccess, index, toggle, settoggle, themecheck, item,  routetouserpage }) {
